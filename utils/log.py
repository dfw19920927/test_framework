...
class Logger(object):
    ...
    def get_logger(self):
        ...
        if not self.logger.handlers:
            ...
            # 每天创建一个日志文件，最多保留backup_count份
            filehandler = TimedRotatingFileHandler(filename=os.path.join(LOG_PATH,self.log_file_name),
                                                   when='D',
                                                   interval=1,
            ...
            filehandler.setLevel(self.file_output_level)
